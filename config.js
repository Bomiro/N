...
module.exports = {
    ...
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/gyd0_' : process.env.URL_1LINK,
    URL_2NAME: process.env.URL_2NAME === undefined ? '✨GROUP_WA✨' : process.env.URL_2NAME,
    URL_2LINK: process.env.URL_2LINK === undefined ? 'https://chat.whatsapp.com/' : process.env.URL_2LINK,
    FOOTER: process.env.FOOTER === undefined ? '𝐍𝐀𝐌𝐗𝟐𝟏𝟐𝐁𝐎𝐓 ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '𝐍𝐀𝐌𝐗𝟐𝟏𝟐𝐁𝐎𝐓' : process.env.CAPTION,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.imgur.com/EisnRmc.jpeg' : process.env.ALIVE_LOGO,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? '𝐍𝐀𝐌𝐗𝟐𝟏𝟐𝐁𝐎𝐓 • @gyd0_' : process.env.STIC_WM,
};
