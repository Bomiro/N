...
module.exports = {
    ...
    URL_2LINK: process.env.URL_2LINK === undefined ? 'https://chat.whatsapp.com/GBcxtV97a7UATq6cESZJI6' : process.env.URL_2LINK,
    FOOTER: process.env.FOOTER === undefined ? '𝙱𝙾𝙱𝙸𝚉 𝙱𝙾𝚃 𝙼𝙳' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🐶BoBiZ 𝙱𝙾T M𝙳 by noureddin🐕' : process.env.CAPTION,
